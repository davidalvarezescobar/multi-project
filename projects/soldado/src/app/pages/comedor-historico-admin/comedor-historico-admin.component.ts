...
export class ComedorHistoricoAdminComponent {
  peticionesList = [
    ...
    { comedor: "Cantina", fecha: "2024-02-19", principal: "Paella de marisco", segundo: "Pollo a la parrilla", postre: "Helado", intorelancias: [], precioMenu: 12, pagado: false, recibido: true, entregado: false },
