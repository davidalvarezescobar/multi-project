...
export class ComedorHistoricoAdminComponent {
  peticionesList = [
    { comedor: "Principal", peticionario: 'Teniente Dam', fecha: "2024-02-19", principal: "Croquetas", segundo: "Pasta carbonara", postre: "Flan casero", intorelancias: [], precioMenu: 12, pagado: true, recibido: true, entregado: true },
